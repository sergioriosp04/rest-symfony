...
class User
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="surnamen", type="string", length=100, nullable=true)
     */
    private $surnamen;
    ...
    public function getSurnamen(): ?string
    {
        return $this->surnamen;
    }

    public function setSurnamen(?string $surnamen): self
    {
